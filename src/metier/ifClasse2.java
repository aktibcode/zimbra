...
public class ifClasse2 extends JInternalFrame {
	...
	private JTextField textFieldTypeEnseig;
		...
		getContentPane().addMouseListener(new MouseAdapter() {
			...
			table.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent arg0) {
					...
					String sql = "select * from classeltc where id_classe = '"+Integer.parseInt(id)+"' and typeEnseig = 'LTC' ";
			...
			bntAjouter.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					String sql = "insert into classeltc (cls_nom, Montant_cls, Montant_Tenue, coef_classe, typeEnseig) values (?,?,?,?,?)";
					...
					try {
							...
							prepared.setString(5, textFieldTypeEnseig.getText().toString());
			...
			btnModifier.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						String sql =" update classeltc set cls_nom = ?, Montant_cls = ?, Montant_tenue = ?, coef_classe = ? where id_classe = ? ";
			...
			btnSupprimer.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					String sql = "delete from classeltc where id_classe = ?";
			...
			JLabel lblTypeEnsg = new JLabel("Type Enseig :");
			lblTypeEnsg.setHorizontalAlignment(SwingConstants.CENTER);
			lblTypeEnsg.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 12));
			lblTypeEnsg.setBounds(271, 31, 135, 23);
			getContentPane().add(lblTypeEnsg);
			
			textFieldTypeEnseig = new JTextField();
			textFieldTypeEnseig.setEnabled(false);
			textFieldTypeEnseig.setEditable(false);
			textFieldTypeEnseig.setText("LTC");
			textFieldTypeEnseig.setColumns(10);
			textFieldTypeEnseig.setBounds(416, 31, 96, 22);
			getContentPane().add(textFieldTypeEnseig);
