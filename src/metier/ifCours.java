...
public class ifCours extends JInternalFrame {
	...
	public ifCours() {
			...
			table.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent arg0) {
					...
					String sql = "select * from cours where cr_id ='"+id+"'";
					try {
			...
			bntAjouter.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					String sql = "insert into cours (cr_titre, cr_coef, id_ty) values (?, ?, ? )";
			...
			btnModifier.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						String sql =" update cours set  cr_titre = ?  , cr_coef = ?  where cr_id = ?";
			...
			btnSupprimer.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					String sql = "delete from cours where cr_id = ?";
			...
			comTypeMa.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					String sql = "select  * from type_matiere where titre = '"+comTypeMa.getSelectedItem()+"'";
					try {
	...
	public void updateTy(){
		...
		String sql = "select  * from type_matiere";
	try {
